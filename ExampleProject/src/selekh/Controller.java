...
public class Controller {
	...
	private static Map<String, String> thing = new HashMap<String, String>();
	static {
		try {
			Class<?> cardManager = Server.class;
			Class<?> request = HttpServletRequest.class;
			Class<?> response = HttpServletResponse.class;
			thing.put("/users/", "user");
			thing.put("/users", "user");
			thing.put("/diagrams/object_relations",
					DiagrTypes.OBJECT_RELATIONAL);
			thing.put("/diagrams/er", DiagrTypes.ER);
			thing.put("/diagrams/er/new", DiagrTypes.ER);
			thing.put("/diagrams/object_relations/new",
					DiagrTypes.OBJECT_RELATIONAL);
			thing.put("/diagrams/usecase/new", DiagrTypes.USE_CASE);
			thing.put("/informational_requirements/sorts/new", "sort");
			thing.put("/informational_requirements/searches/new", "search");
			thing.put("/informational_requirements/filters/new", "filter");
	...
	private static void routeDiagrTypes(Method m, String url,
		...
		try {
			m.invoke(m.getDeclaringClass().newInstance(), thing.get(url),
					request, response);
